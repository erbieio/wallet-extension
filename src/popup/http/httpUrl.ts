...
export const scanApi = isProduct ? 'https://api.erbie.io' : 'https://api.wormholesscan.com'
...
export const nftUrl = isProduct ? 'http://www.erbiescan.io' : 'http://43.129.181.130:3001'
