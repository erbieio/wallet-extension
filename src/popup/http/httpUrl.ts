...
export const scanApi = isProduct ? 'https://api.erbiescan.io' : 'https://api.wormholesscan.com'
...
export const nftUrl = isProduct ? 'https://api.erbiescan.io' : 'http://43.129.181.130:3001'
