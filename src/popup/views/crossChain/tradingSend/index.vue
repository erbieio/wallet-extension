<template>
    ...
    <div class="page-container">
        <div class="mt-14 mr-14 pl-14 userinfo-box">
            <div class="mt-20 mb-20 f-14 text-center tx-cross-info lh-30">
                {{ headerTit }}
            </div>
    ...
    <AccountModal v-model="showModal" :hasBtn="false"></AccountModal>
</template>
...
import SendConfirm from "@/popup/views/crossChain/components/sendConfirm.vue";
import eventBus from "@/popup/utils/bus";
import { useToast } from "@/popup/plugins/toast";
import abi from '@/popup/assets/json/crossChainAbi.json'
